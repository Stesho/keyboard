  ...
  line.forEach((key) => {
    ...
    switch (key.code) {
      ...
      case 'Backspace':
        ...
        break;
      case 'CapsLock':
        keyElement.classList.add('keyboard__caps-lock');
        break;
      case 'Enter':
      ...
      case 'ShiftLeft':
      case 'ShiftRight':
        keyElement.classList.add('keyboard__shift');
        break;
      case 'ControlLeft':
      case 'ControlRight':
        keyElement.classList.add('keyboard__ctr');
        break;
      case 'AltLeft':
      case 'AltRight':
        keyElement.classList.add('keyboard__alt');
        break;
      case 'Space':
